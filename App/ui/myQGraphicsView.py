...
class myQGraphicsView(QGraphicsView):
    ...
    def getResult(self):
        if self.crop_end == self.crop_start or abs(self.crop_end.x() - self.crop_start.x()) < 20 or abs(
                self.crop_end.y() - self.crop_start.y()) < 20:
            return None, None
        else:
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        toolButton.setIcon(
            QIcon(r'E:\University\2023-2024\Semester_1\Pj\coursework\gitProject\project_1\ImageEditor\icons\crop.png'))
